...
import { editorTesto } from './modules/editor-testo';
import { immagineDescritta } from './modules/immagine-descritta';
...
Alpine.data('editorTesto', editorTesto);
Alpine.data('immagineDescritta', immagineDescritta);
